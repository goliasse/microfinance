<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="loanapplications.aspx.cs" Inherits="pages_loanapplications" Title="Loan Applications" %>
<%@ Register src="~/controls/LoanApplications/clientlist.ascx" tagname="clientlist" tagprefix="uc1" %>
               ...
               <div class="navbar-header">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav mnustyle cf">
                    ...
                    <li>
                        <asp:LinkButton ID="btndisbursement" runat="server" 
