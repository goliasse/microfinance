<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="approved.aspx.cs"
    Inherits="pages_invapplication_approved" Title="Approved Investments" %>

<%@ Register src="../../controls/invapplications/setValuedDate.ascx" tagname="setValuedDate" tagprefix="uc1" %>
<%@ Register src="../../controls/invapplications/InvApplicationDetails.ascx" tagname="InvApplicationDetails" tagprefix="uc2" %>

<%@ Register src="../../controls/invapplications/invcomments.ascx" tagname="invcomments" tagprefix="uc3" %>
<%@ Register src="../../controls/invapplications/advise.ascx" tagname="advise" tagprefix="uc4" %>
                    ...
                    <div class="col-md-12" id="rootwizard" style="padding-left: 0">
                        <div class="navbar col-md-3" style="padding-left: 0; padding-right: 0;">
                            <div class="container col-md-12" style="padding-left: 0; padding-right: 0;">
                                <ul class="mli nav nav-stacked bootstrap-admin-navbar-side">
                                    <li>
                                        <asp:LinkButton runat="server" ID="btnSetValueDate"><h6>Set Value Date</h6></asp:LinkButton></li>
                                    <li>
                                        <asp:LinkButton ID="btnAppDetails" runat="server"><h6>Application Details </h6></asp:LinkButton></li>
                                    <li>
                                        <asp:LinkButton ID="btnInvAdvise" runat="server"><h6>Inv Advise / Instructions  </h6></asp:LinkButton></li>
                                    <li>
                        ...
                        <div class="col-md-9 tab-content">
                            <div class="tab-pane_" style="min-height: 450px">
                                <!-- content -->
                                <uc3:invcomments ID="invcomments1" runat="server" />
                                <uc1:setValuedDate ID="setValuedDate1" runat="server" />
                                <uc2:InvApplicationDetails ID="InvApplicationDetails1" runat="server" />
                                <uc4:advise ID="advise1" runat="server" />
                            </div>
