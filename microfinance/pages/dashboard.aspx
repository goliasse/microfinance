<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="dashboard.aspx.cs" Inherits="dashboard" Title="SA 365 Microfinance Dashboard" %>

<%@ Register src="../controls/dashboard/dbi_clients.ascx" tagname="dbi_clients" tagprefix="uc1" %>

<%@ Register src="../controls/dashboard/dbi_databar.ascx" tagname="dbi_databar" tagprefix="uc2" %>

<%@ Register src="../controls/dashboard/dbi_payments.ascx" tagname="dbi_payments" tagprefix="uc3" %>

<%@ Register src="../controls/dashboard/dbi_portfolios.ascx" tagname="dbi_portfolios" tagprefix="uc4" %>

<%@ Register src="../controls/dashboard/dbi_debt_provision.ascx" tagname="dbi_debt_provision" tagprefix="uc5" %>

<%@ Register src="../controls/dashboard/dbi_financials.ascx" tagname="dbi_financials" tagprefix="uc6" %>
...
<div class="col-md-10">
    <div class="row">
        <div class="alert alert-success bootstrap-admin-alert">
            ...
            <h4>Success</h4>
            You are welcome, Login was successfull
        </div>
    </div>
...
<%--    <div class="row">
    ...
    <%--<uc1:dbi_clients ID="dbi_clients1" runat="server" />--%>
    <uc2:dbi_databar ID="dbi_databar1" runat="server" />
    <uc3:dbi_payments ID="dbi_payments1" runat="server" />
    <uc4:dbi_portfolios ID="dbi_portfolios1" runat="server" />
    <uc5:dbi_debt_provision ID="dbi_debt_provision1" runat="server" />
    <uc6:dbi_financials ID="dbi_financials1" runat="server" />
<%--<div class="row">
...
<div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content collapse in">
    <div class="col-md-3">
        <div class="easyPieChart" data-percent="73" style="width: 110px; height: 110px; line-height: 110px;">
            73%<canvas width="110" height="110"></canvas></div>
        <div class="chart-bottom-heading"><span class="label label-info">Visitors</span></div>
    </div>
    <div class="col-md-3">
        <div class="easyPieChart" data-percent="53" style="width: 110px; height: 110px; line-height: 110px;">
            53%<canvas width="110" height="110"></canvas></div>
        <div class="chart-bottom-heading"><span class="label label-info">Page Views</span>
        </div>
    </div>
    <div class="col-md-3">
        <div class="easyPieChart" data-percent="83" style="width: 110px; height: 110px; line-height: 110px;">
            83%<canvas width="110" height="110"></canvas></div>
        <div class="chart-bottom-heading"><span class="label label-info">Users</span></div>
    </div>
    <div class="col-md-3">
        <div class="easyPieChart" data-percent="13" style="width: 110px; height: 110px; line-height: 110px;">
            13%<canvas width="110" height="110"></canvas></div>
        ...
        <div class="col-md-4">
            <div class="panel panel-danger">
              <div class="panel-heading">
                <div class="row">
                  <div class="col-xs-6">
                    <h1 class="glyphicon glyphicon-tasks"></h1> 
                  </div>
