...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="mPanelContent" runat="server">
        ...
        <div class="panel panel-default bootstrap-admin-no-table-panel">
            ...
            <div class="col-md-12 alert alert-info" style="height:75px; padding:8px">
                    <a class="close" data-dismiss="alert" href="#">×</a>
                    <span>Application Information</span>
                    <hr style="margin:2px 0;color:White" />
                    <div class="col-md-6">
                        <span class="text-warning">Applicant:</span> <span id="lblapplicantName" runat="server"></span><br />
