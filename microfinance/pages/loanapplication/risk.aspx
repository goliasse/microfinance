<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="risk.aspx.cs" Inherits="pages_loanapplication_risk" Title="Loan Risk Reporting " %>
<%@ Register src="~/controls/LoanApplications/appDetailRpt.ascx" tagname="appDetailRpt" tagprefix="uc1" %>
<%@ Register src="~/controls/LoanApplications/applicationRpt.ascx" tagname="applicationRpt" tagprefix="uc2" %>
<%@ Register src="~/controls/LoanApplications/riskReport.ascx" tagname="riskReport" tagprefix="uc3" %>
<%@ Register src="~/controls/LoanApplications/SupportingDocRpt.ascx" tagname="SupportingDocsRpt" tagprefix="uc4" %>
    ...
    <asp:Panel ID="mPanelContent" runat="server">
        ...
        <div class="panel panel-default bootstrap-admin-no-table-panel">
            <div class="panel-heading">
                <div class="text-muted bootstrap-admin-box-title">Risk Reporting</div>
            </div>
                    ...
                    <div class="navbar col-md-3">
                        ...
                        <div class="container col-md-12">
                            <ul class="mli nav nav-stacked bootstrap-admin-navbar-side">
                                <li><asp:LinkButton ID="btnPreAppRpt" runat="server"><h6>Pre Approval Report </h6></asp:LinkButton></li>
                                <li><asp:LinkButton ID="btnAppRpt" runat="server"><h6>Application Report </h6></asp:LinkButton></li>
                                <li><asp:LinkButton ID="btnSuppDoc" runat="server"><h6>Supporting Doc </h6></asp:LinkButton></li>
                                <li><asp:LinkButton ID="btnRiskRpt" runat="server"><h6>Write Risk Report </h6></asp:LinkButton></li>                       
                            </ul>
                  ...
                  <%--  <div id="bar" class="progress progress-striped active">
                    ...
                    <div class="tab-content col-md-9">
                        <div class="tab-pane_" id="tab1">
                            ...
                            <uc3:riskReport ID="riskReport1" runat="server" />
                        ...
                        <ul class="pager wizard">
                            ...
                            <li class="next"><asp:LinkButton ID="btnNext" runat="server" 
                                    onclick="btnNext_Click">Next</asp:LinkButton></a></li>
        ...
        <div class="modal-dialog" style="width:298px" >
            <div class="modal-content"  style="display:none" runat="server" id="popup101" >
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="myModalAlertLabel">Alert On Account</h5>
                </div>
                <div class="modal-body">
                    <p runat="server" id="pAlertmsg"></p>
                </div>
                <div class="modal-footer" style="height:20px">
                    <button class="btn btn-xs btn-primary" id="btnRemoveAlert" runat="server" onclick="removeAlert()" type="button">
                        Remove Alert</button>
                    <button class="btn btn-xs btn-default" onclick="closeAlert()" type="button">Close</button>
                </div>
                <br />
                <br />
            </div>  
