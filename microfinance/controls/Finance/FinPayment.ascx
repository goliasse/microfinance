<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FinPayment.ascx.cs" Inherits="controls_Finance_FinPayment" %>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <label class="col-lg-3 control-label" for="optionsCheckbox">
                                Select Payment Voucher Type:</label>
           <div class="col-lg-3">
...
<asp:Panel runat="server" ID="VchPanel" class="panel panel-default bootstrap-admin-no-table-panel">
    <div class="panel-heading">
        <div class="text-muted bootstrap-admin-box-title">
                Payment&nbsp; Voucher <asp:Label ID="subVchName" runat ="server" ></asp:Label>
        </div>
                ...
                <fieldset>
                    ...
                    <asp:Panel runat ="server" ID ="transactionsPanel">  
                        <div class="col-md-12 alert alert-info" style="padding: 8px">
                            ...
                            <div class="col-md-4">
                                <span class="text-warning">Initial Amount:</span> <span id="lblInvestmentAmount"
                                    runat="server"></span>
                                <br />
                            </div>
                            <div class="col-md-4">
                               <span class="text-warning">Account Name:</span> <span id="lblInvestmentName" runat="server">
                                </span>
                                <br />
                            </div>
                        </div>
