...
public partial class controls_Finance_FinReceipt : System.Web.UI.UserControl
{
           ...
           { 
               try
               {
                   int id = Convert.ToInt32(Request.QueryString["id"]);
                    ...
                    Response.Redirect("~/pages/finance/finhome.aspx?panel=Receipt&action="+System.Guid.NewGuid().ToString());
               }
               catch(Exception ex){}
               loadAccItems();
