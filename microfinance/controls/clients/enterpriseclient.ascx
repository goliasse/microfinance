<%@ Control Language="C#" AutoEventWireup="true" CodeFile="enterpriseclient.ascx.cs" Inherits="controls_clients_enterpriseclient" %>
<div class="col-md-12">
                ...
                <div class="form-group">
                   <div class="col-lg-10" >
                        <asp:Button ID="btnSave"  
                            class="btn btn-xs btn-success col-md-3" runat="server" Text="UPDATE" 
