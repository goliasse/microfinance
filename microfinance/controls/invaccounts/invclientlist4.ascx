<%@ Control Language="C#" AutoEventWireup="true" CodeFile="invclientlist4.ascx.cs" Inherits="controls_invaccounts_invclientlist4" %>
...
<p style="margin: 0">
    <asp:Label ID="lblHeading" runat="server" Style="font-weight: 700" Text="Number of Item(s)"></asp:Label><span
...
<asp:GridView ID="gvClients" runat="server" CssClass="table table-bordered" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Client No."></asp:TemplateField>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT datID, datInvestmentName, datApplicationNumber, datClientID, datInvestmentType, datInvestmentAmount FROM tbl_investment_accounts WHERE (datActiveAccountStatus = 5) OR (datPaymentStatus = 5)" 
