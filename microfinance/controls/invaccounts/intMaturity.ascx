<%@ Control Language="C#" AutoEventWireup="true" CodeFile="intMaturity.ascx.cs" Inherits="controls_invaccounts_intMaturity" %>
...
<script type="text/javascript">
   $(document).ready(function() {
		...
		$("#<%= payout.ClientID %>").val((parseFloat($("#<%=datInterest.ClientID  %>").val()) + parseFloat($("#<%= datprincipal.ClientID %>").val())))
