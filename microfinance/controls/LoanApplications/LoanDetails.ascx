<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LoanDetails.ascx.cs" Inherits="controls_LoanDetails" %>
        ...
        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
            <div class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-lg-10">
                            <asp:Button ID="btnSave" runat="server" CssClass="btn btn-xs btn-success col-md-3"
                                Text="SAVE" OnClick="btnSave_Click" />
                        </div>
                    </div>
                </fieldset>
            </div>
            <asp:CustomValidator ID="vIntialAssesment" runat="server" CssClass="vItem col-md-12" OnServerValidate="pageValidation"
                ErrorMessage="">
