<%@ Control Language="C#" AutoEventWireup="true" CodeFile="preliminaryrpt.ascx.cs"
    Inherits="controls_preliminaryrpt" %>
<div class="row">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
        ...
        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
            <div class="form-horizontal">
                ...
                <hr />
                <asp:CustomValidator ID="vPrelimaryRpt" runat="server" CssClass="vItem col-md-12" OnServerValidate="pageValidation"
                    ErrorMessage="">              
