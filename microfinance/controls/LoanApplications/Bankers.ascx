<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Bankers.ascx.cs" Inherits="controls_Bankers" %>
<div class="row">
        ...
        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
            <div class="form-horizontal">
                <fieldset>
                    ...
                    <asp:CustomValidator ID="vBankers" runat="server" CssClass="vItem col-md-12" OnServerValidate="pageValidation"
                        ErrorMessage="">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sa365ConnectionString1 %>"
                SelectCommand="getBankers" SelectCommandType="StoredProcedure">
                <SelectParameters>
