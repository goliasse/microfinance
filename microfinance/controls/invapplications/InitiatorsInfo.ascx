<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InitiatorsInfo.ascx.cs" Inherits="controls_invapplications_InitiatorsInfo" %>
<div class="row">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
        <div class="panel-heading">
            <div class="text-muted bootstrap-admin-box-title">
                Initiators Personal Information
            </div>
        </div>
            ...
            <div class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input runat="server" type="text" class="form-control" id="txtOfficePhone"
                                autocomplete="off" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label" for="txtMobile">
                            Fax Number</label>
                        <div class="col-lg-9">
                            <input runat="server" type="text" class="form-control " id="txtfaxnumber"
                                autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
