<%@ Control Language="C#" AutoEventWireup="true" CodeFile="supportingdocs.ascx.cs"
    Inherits="controls_invapplications_supportingdocs" %>
<div class="row">
        ...
        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
            <div class="form-horizontal">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sa365ConnectionString1 %>"
                    SelectCommand="GetInvSupportingDocs" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter DefaultValue="1" Name="clientID" SessionField="ClientID" Type="Int32" />
                        <asp:SessionParameter DefaultValue="" Name="InvAppID" SessionField="InvAppID" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>
        </div>
