<%@ Control Language="C#" AutoEventWireup="true" CodeFile="coporateInfo.ascx.cs" Inherits="controls_invapplications_coporateInfo" %>
                ...
                <fieldset>
                    ...
                    <div runat=server id="RegisteredPanel" style="display:none">
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                    <asp:TextBox ID="txtRegistrationDate" class="form-control input-sm col-md-5 my-picker" runat="server"></asp:TextBox>
                            </div>
                        </div>
                         <div class="form-group">
