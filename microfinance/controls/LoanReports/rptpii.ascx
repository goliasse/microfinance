<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rptpii.ascx.cs" Inherits="controls_LoanReports_rptpii" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=9.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
    <style type="text/css">
        .form-group{margin-bottom:0}
    </style>
 <h6><small>PORTFOLIO INTEREST INCOME</small></h6>
 <div class="col-md-12 alert alert-info" style="max-height:140px;min-height:80px">
        ...
        <div class="form-horizontal">
            ...
            <div id="ctrlFromDT" runat="server"  class="col-md-4 form-group">
             ...
             <div id="ctrlPerforming"  class="col-md-4 form-group">
                ...
                <div class="col-md-7">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:sa365ConnectionString1 %>" 
                        SelectCommand="SELECT [datID], [datDescription] FROM [opt_performance]">
                    </asp:SqlDataSource>
                </div>
            </div>
            <div id="ctrlToDT" runat="server"  class="col-md-4 form-group">
    ...
    <hr style="margin:3px" />
        <rsweb:ReportViewer ID="rvPII" runat="server" Font-Names="Verdana" 
            Font-Size="8pt" Height="400px" Width="100%">
            <LocalReport ReportPath="report\Loan Reports\rPortfolioInterestIncome.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="LoanReport_Report_Portfolio_Interest_Income" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            SelectMethod="GetReport_Portfolio_Interest_Income" 
            TypeName="LoanReportTableAdapters.Report_Portfolio_Interest_IncomeTableAdapter">
            <SelectParameters>
                <asp:Parameter DefaultValue="1/1/1900" Name="FromDT" Type="String" />
                <asp:Parameter DefaultValue="1/1/1900" Name="ToDT" Type="String" />
                <asp:ControlParameter ControlID="ddlBranch" DefaultValue="" Name="BranchID" 
                    PropertyName="SelectedValue" Type="Int32" />
                <asp:ControlParameter ControlID="ddlct" Name="CMID" 
                    PropertyName="SelectedValue" Type="Int32" />
                <asp:ControlParameter ControlID="ddlPerformance" Name="Type" 
                    PropertyName="SelectedValue" Type="Int32" />
                <asp:ControlParameter ControlID="ddlCategory" Name="category" 
                    PropertyName="SelectedValue" Type="Int32" />
            </SelectParameters>
        </asp:ObjectDataSource>
    <hr />
