<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rptPortfolioAging.ascx.cs" Inherits="controls_LoanReports_rptPortfolioAging" %>
...
<style type="text/css">
 ...
 <h6><small>Portfolio Aging Report</small></h6>
 <div class="col-md-12 alert alert-info" style="max-height:140px;min-height:80px">
    ...
    <hr style="margin:3px" />
        <rsweb:ReportViewer ID="rvAging" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="report\Loan Reports\rptPortfolioAging.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource2" 
                        Name="LoanReport_Report_Portfolio_Aging" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
            ...
            SelectMethod="GetReport_Portfolio_Aging" 
            TypeName="LoanReportTableAdapters.Report_Portfolio_AgingTableAdapter">
            <SelectParameters>
