<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rptPSR.ascx.cs" Inherits="controls_LoanReports_rptPSR" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=9.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
    <style type="text/css">
        .form-group{margin-bottom:0}
    </style>
 <h6><small>PROVIOSION SUMMARY REPORT</small></h6>
 <div class="col-md-12 alert alert-info" style="max-height:140px;min-height:80px">
    ...
    <hr style="margin:3px" />
        <rsweb:ReportViewer ID="rvPSR" runat="server" Font-Names="Verdana" 
            Font-Size="8pt" Height="400px" Width="100%">
            <LocalReport ReportPath="report\Loan Reports\rProvisionSummaryReport.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="LoanReport_Report_Provision_Summary" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            SelectMethod="GetReport_Provision_Summary" 
            TypeName="LoanReportTableAdapters.Report_Provision_SummaryTableAdapter">
            <SelectParameters>
