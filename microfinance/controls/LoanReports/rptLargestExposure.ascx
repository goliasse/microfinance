<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rptLargestExposure.ascx.cs" Inherits="controls_LoanReports_rptLargestExposure" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=9.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
    <style type="text/css">
        .form-group{margin-bottom:0}
    </style>
 <h6><small>Largest Exposure Report</small></h6>
 <div class="col-md-12 alert alert-info" style="max-height:140px;min-height:80px">
        ...
        <div class="form-horizontal">
            ...
            <div id="ctrlFromDT" runat="server"  class="col-md-4 form-group">
                <label class="col-md-5"> Top:</label>
                <div class="col-md-7">
                    <asp:TextBox ID="txtTop" CssClass="form-control input-sm col-md-6" runat="server"></asp:TextBox>
                </div>
            </div>
    ...
    <hr style="margin:3px" />
        <rsweb:ReportViewer ID="rvLargestExposure" runat="server" Font-Names="Verdana" 
            Font-Size="8pt" Height="400px" Width="100%">
            <LocalReport ReportPath="report\Loan Reports\rlargestexposure.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="LoanReport_Report_Largest_Exposure" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            SelectMethod="GetReport_Largest_Exposure" 
            TypeName="LoanReportTableAdapters.Report_Largest_ExposureTableAdapter" 
