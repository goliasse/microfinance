<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rptClientMovement.ascx.cs" Inherits="controls_LoanReports_rptClientMovement" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=9.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
    <style type="text/css">
        .form-group{margin-bottom:0}
    </style>
 <h6><small>Client Movement Report</small></h6>
 <div class="col-md-12 alert alert-info" style="max-height:140px;min-height:80px">
    ...
    <hr style="margin:3px" />
        <rsweb:ReportViewer ID="rvClientMovement" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="report\Loan Reports\rClientMovement.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="LoanReport_Report_Client_Movement" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            SelectMethod="GetReport_Client_Movement" 
            TypeName="LoanReportTableAdapters.Report_Client_MovementTableAdapter">
            <SelectParameters>
