<%@ Control Language="C#" AutoEventWireup="true" CodeFile="interestratetypes.ascx.cs" Inherits="controls_assets" %>
<div class="row">
<div class="panel panel-default bootstrap-admin-no-table-panel">
    <div class="panel-heading">
        <div class="text-muted bootstrap-admin-box-title">Interesst Rate Types</div>
    </div>
    <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
        <div class="form-horizontal">
            <fieldset>
                <legend><h5>Interest Rate Types</h5></legend>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ...
                SelectCommand="GetInterestRateTypes" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </div>
  </div>
