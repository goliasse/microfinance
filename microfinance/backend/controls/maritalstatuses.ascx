<%@ Control Language="C#" AutoEventWireup="true" CodeFile="maritalstatuses.ascx.cs" Inherits="controls_assets" %>
<div class="row">
<div class="panel panel-default bootstrap-admin-no-table-panel">
    <div class="panel-heading">
        <div class="text-muted bootstrap-admin-box-title">Marital Status</div>
    </div>
    <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
        <div class="form-horizontal">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ...
                SelectCommand="GetMaritalStatuses" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </div>
  </div>
