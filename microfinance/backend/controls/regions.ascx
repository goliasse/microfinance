<%@ Control Language="C#" AutoEventWireup="true" CodeFile="regions.ascx.cs" Inherits="controls_assets" %>
<div class="row">
<div class="panel panel-default bootstrap-admin-no-table-panel">
    <div class="panel-heading">
        <div class="text-muted bootstrap-admin-box-title">Region</div>
    </div>
    <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
        <div class="form-horizontal">
            <fieldset>
                <legend><h5>Region</h5></legend>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ...
                SelectCommand="GetOptRegion" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </div>
  </div>
