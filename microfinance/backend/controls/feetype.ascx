<%@ Control Language="C#" AutoEventWireup="true" CodeFile="feetype.ascx.cs" Inherits="controls_assets" %>
<div class="row">
<div class="panel panel-default bootstrap-admin-no-table-panel">
    <div class="panel-heading">
        <div class="text-muted bootstrap-admin-box-title">Fee Type</div>
    </div>
    <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
        <div class="form-horizontal">
            <fieldset>
                <legend><h5>Fee Type</h5></legend>
            ...
            <hr />
            <asp:GridView CssClass="table table-striped" ID="gvFeeType" runat="server" 
                AutoGenerateColumns="False" DataKeyNames="datID" 
                DataSourceID="SqlDataSource2" onrowdatabound="gvFeeType_RowDataBound" 
                        onselectedindexchanged="gvFeeType_SelectedIndexChanged">
                <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ...
                SelectCommand="GetFeeType" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </div>
  </div>
